import "clsx";
import { a2 as sanitize_props, a3 as rest_props, _ as fallback, a4 as spread_attributes, a5 as clsx, a6 as slot, a0 as bind_props, W as pop, T as push, $ as attr, a1 as stringify } from "../../../../chunks/index.js";
...
function Contactbox($$payload, $$props) {
  ...
  $$payload.out += `<div><div${attr("class", `outline-2 outline-white p-4 bg-zinc-900 rounded-lg shadow-lg border border-gray-700 ${stringify(className)}`)}><h1 class="text-2xl font-bold">Contact Us</h1> <div class="text-xl">`;
  P($$payload, {
    children: ($$payload2) => {
